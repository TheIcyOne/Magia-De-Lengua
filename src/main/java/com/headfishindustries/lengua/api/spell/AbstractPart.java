...
public abstract class AbstractPart extends IForgeRegistryEntry.Impl<AbstractPart>{
	 ...
	 **/
	public abstract EnumActionResult applyEffectEntity(Entity target, World world, Energy modifiers, Spell spell, EntityLivingBase caster);
	
	public abstract EnumActionResult applyEffectBlock(BlockPos target, World world, Energy modifiers, Spell spell, EntityLivingBase caster);
